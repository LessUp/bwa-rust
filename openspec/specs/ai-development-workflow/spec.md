...
Define the repository-level workflow expectations for AI-assisted development so OpenSpec, implementation tools, and review tools are used consistently during closeout work.
