...
Define the public-facing narrative rules for README, GitHub Pages, and repository metadata so the project is presented truthfully and usefully during closeout.
