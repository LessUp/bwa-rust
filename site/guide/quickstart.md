...
本文档介绍 bwa-rust 的基本用法。如需详细安装说明，请参考 [安装指南](./installation)。
...
**注意**: 配对端对齐基础架构已存在于代码中，但尚未通过 CLI 暴露。
...
bwa-rust 提供 library API，可在 Rust 项目中直接调用索引构建和比对功能。详见 [核心算法文档](../architecture/algorithms.md)。
