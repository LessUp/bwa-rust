...
>
> 文中 `@bwa-0.7.19/...` 引用指向原 C 版 BWA 源码的文件与行号，该目录已从仓库移除，引用仅作算法溯源参考。
...
- [当前基线](#当前基线)
- [阶段 0：基准梳理](#阶段-0基准梳理)
  - [0.1 索引文件格式与 Rust 读写结构](#01-索引文件格式与-rust-读写结构)
  - [0.2 bseq_read 批处理协议 → Rust pipeline](#02-bseq_read-批处理协议--rust-pipeline)
  - [0.3 bwa mem 参数 → Rust 配置映射](#03-bwa-mem-参数--rust-配置映射)
- [阶段 1：索引管线](#阶段-1索引管线)
  - [1.1 FASTA→PAC/ANN/AMB 构建流水](#11-fastapacannamb-构建流水)
  - [1.2 BWT/SA/FMD 构建策略](#12-bwtsafmd-构建策略)
  - [1.3 索引 CLI 与并行策略](#13-索引-cli-与并行策略)
- [阶段 2：BWA-backtrack 系列](#阶段-2bwa-backtrack-系列)
  - [2.1 aln 流水与 Rust 模块划分](#21-aln-流水与-rust-模块划分)
  - [2.2 samse/sampe 与配对策略](#22-samsesampe-与配对策略)
  - [2.3 bwasw / banded DP 设计](#23-bwasw--banded-dp-设计)
- [阶段 3：BWA-MEM](#阶段-3bwa-mem)
  - [3.1 MEM seeding & 链化](#31-mem-seeding--链化)
  - [3.2 链到 DP 比对与 CIGAR 生成](#32-链到-dp-比对与-cigar-生成)
  - [3.3 配对处理与标志位](#33-配对处理与标志位)
  - [3.4 SIMD 与多线程策略](#34-simd-与多线程策略)
- [阶段 4：工具与整合](#阶段-4工具与整合)
  - [4.1 附属工具在 Rust 中的定位](#41-附属工具在-rust-中的定位)
  - [4.2 CLI 兼容层设计](#42-cli-兼容层设计)
  - [4.3 文档与示例脚本](#43-文档与示例脚本)
- [阶段 5：验证](#阶段-5验证)
  - [5.1 正确性验证策略](#51-正确性验证策略)
  - [5.2 性能基线与基准测试](#52-性能基线与基准测试)
  - [5.3 CI 规划](#53-ci-规划)
- [关键技术决策](#关键技术决策)
- [风险与缓解](#风险与缓解)
- [模块依赖图与依赖关系](#模块依赖图与依赖关系草案)
