...
> This document details the bwa-rust alignment algorithm workflow, including SMEM seed finding, chain building, Smith-Waterman alignment, and the complete pipeline.
...
- [Index Building Details](./index-building.md) — FM-index construction
